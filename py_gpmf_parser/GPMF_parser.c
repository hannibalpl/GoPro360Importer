...
// Dummy funkcja do testu
static PyObject* say_hello(PyObject* self, PyObject* args)
{
    return PyUnicode_FromString("Hello from GPMF parser extension");
}

// Tablica metod
static PyMethodDef GpmfMethods[] = {
    {"say_hello", say_hello, METH_NOARGS, "Return a greeting from C extension."},
    {NULL, NULL, 0, NULL}
};

// Definicja modułu
static struct PyModuleDef gpmf_parser_module = {
    PyModuleDef_HEAD_INIT,
    "gpmf_parser",   // Nazwa modułu
    NULL,            // Dokumentacja
    -1,              // Rozmiar stanu per-interpreter
    GpmfMethods
};
...
{
    return PyModule_Create(&gpmf_parser_module);
}
